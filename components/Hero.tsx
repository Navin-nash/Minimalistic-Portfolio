  ...
  return (
    <div className='pb-20 pt-36'>
        <div>
          ...
          <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.05] b-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
