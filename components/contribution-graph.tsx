...
const THEME = cn(
  ...
  'data-[level="1"]:fill-cyan-200/50 dark:data-[level="1"]:fill-cyan-500/20',
  'data-[level="2"]:fill-cyan-300/70 dark:data-[level="2"]:fill-cyan-500/45',
  'data-[level="3"]:fill-cyan-400/90 dark:data-[level="3"]:fill-cyan-500/70',
  'data-[level="4"]:fill-cyan-500 dark:data-[level="4"]:fill-cyan-400'
)
...
export const ContributionGraphLegend = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className="mr-1 text-current opacity-80">
